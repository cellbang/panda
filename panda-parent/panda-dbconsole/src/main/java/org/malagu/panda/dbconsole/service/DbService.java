...
import org.malagu.panda.dbconsole.DbConstants;
import org.malagu.panda.dbconsole.DbType;
import org.malagu.panda.dbconsole.jdbc.dialect.IDialect;
import org.malagu.panda.dbconsole.model.ColumnInfo;
import org.malagu.panda.dbconsole.model.DbInfo;
import org.malagu.panda.dbconsole.model.SqlWrapper;
import org.malagu.panda.dbconsole.service.impl.DbCommonServiceImpl;
import org.malagu.panda.dbconsole.utils.SpringJdbcUtils;
import org.malagu.panda.dbconsole.utils.UserConfigUtils;
...
public class DbService extends DbCommonServiceImpl {
	...
	public void insertColumn(String dbInfoId, ColumnInfo columnInfo) throws Exception {
		org.malagu.panda.dbconsole.jdbc.dialect.ColumnInfo dbColumnInfo = new org.malagu.panda.dbconsole.jdbc.dialect.ColumnInfo();
	...
	public void updateColumn(String dbInfoId, ColumnInfo oldColumnInfo, ColumnInfo newColumnInfo) throws Exception {
		org.malagu.panda.dbconsole.jdbc.dialect.ColumnInfo oldDbColumnInfo = new org.malagu.panda.dbconsole.jdbc.dialect.ColumnInfo();
		BeanUtils.copyProperties(oldDbColumnInfo, oldColumnInfo);
		org.malagu.panda.dbconsole.jdbc.dialect.ColumnInfo newDbColumnInfo = new org.malagu.panda.dbconsole.jdbc.dialect.ColumnInfo();
