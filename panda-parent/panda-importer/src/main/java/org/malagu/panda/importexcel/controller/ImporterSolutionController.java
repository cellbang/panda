package org.malagu.panda.importexcel.controller;
...
import org.malagu.panda.importexcel.filter.EntityTypeFilter;
...
import org.malagu.panda.importexcel.policy.AutoCreateMappingRulePolicy;
	...
	public void saveImporterSolutions(Collection<ImporterSolution> importerSolutions) {
		JpaUtil.save(importerSolutions, new SmartSavePolicy() {
			...
			public void apply(SaveContext context) {
				if (context.getEntity() instanceof org.malagu.panda.importexcel.model.Entry) {
					MappingRule mappingRule = context.getParent();
					org.malagu.panda.importexcel.model.Entry entry = context.getEntity();
