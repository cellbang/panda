package org.malagu.panda.swfviewer.controller;
...
public class PdfToSwfConverter {
	...
	private String pdfToSwfPath = Configure.getString("panda.swfviewer.pdfToSwf");
	private String xpdfPath = Configure.getString("panda.swfviewer.xpdfPath");
