dorado.widget.SwfViewer = $extend(dorado.widget.Control, {
	...
	_embedSWF : function() {
		var viewer = this, url = "", id = jQuery(viewer.getDom()).attr('id'), defaultUrl = "dorado/panda/swfviewer/swfFile.do", expressInstallSwfurl = $url(">dorado/res/dorado/resources/flash/expressInstall.swf");
