	...
	dorado.widget.Export2ReportAction = $extend(dorado.widget.AjaxAction, {
		...
		getAjaxOptions : function() {
			...
			var jsonData = {
				...
				service : "panda.Export2ReportController#generateReportFile",
		...
		doDowloadReport : function(data) {
			...
			var name = data.name;
			if (id && name) {
				var url = "dorado/panda/export/doDownloadFile?id=" + encodeURIComponent(id) + "&name=" + encodeURIComponent(name);
