...
public class DownloadReportResolver extends AbstractResolver {
	...
	public String extensionFileType = Configure.getString("malagu.export.extension.fileType");
	...
	private void doDownloadReport(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String loginUserSessionKey = Configure.getString("malagu.export.loginUserSessionKey");
