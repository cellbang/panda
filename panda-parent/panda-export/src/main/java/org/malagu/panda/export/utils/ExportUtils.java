package org.malagu.panda.export.utils;
...
public class ExportUtils {
	...
	public static String getFileStorePath() {
		String fileLocation = Configure.getString("panda.export.location");
		if (StringUtils.isNotEmpty(fileLocation)) {
			...
			File file = new File(fileLocation + "panda-export-temp");
			if (!file.exists()) {
				file.mkdirs();
			}
			return fileLocation + "panda-export-temp"+ File.separator;
		}
	}
