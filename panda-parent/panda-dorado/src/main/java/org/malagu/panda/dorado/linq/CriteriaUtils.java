package org.malagu.panda.dorado.linq;
...
public class CriteriaUtils {
   ...
   * @return 条件载体
   */
  public static Criteria add(Criteria criteria, String propertyName, FilterOperator filterOperator,
      Object value) {
    if (criteria == null) {
      criteria = new Criteria();
    }
   ...
   * @return 条件载体
   */
  public static Junction add(Junction junction, String propertyName, FilterOperator filterOperator,
      Object value) {
    SingleValueFilterCriterion criterion = new SingleValueFilterCriterion();
    criterion.setProperty(propertyName);
    criterion.setFilterOperator(filterOperator);
