...
public class QueryPreLoadPropertyWrapperServiceImpl
    implements QueryPropertyWrapperService, ReflectionRegister {

  private static final Logger logger = LoggerFactory.getLogger(HibernateEntityEnhancerImpl.class);

  private static MapMap<Class<?>, String, PropertyWrapper> golbalPropertyWrapperMap =
  ...
  public static final String[] QUERY_OPERATOR =
      new String[] { /* "Eq", */"Ge", "Gt", "In", "Le", "Like", "LikeEnd", "Lt", "Ne", "Between"};
  ...
  public void register(Class<?> clazz, Field field) {
    ...
    if (!type.equals(Object.class)) {
      ...
      for (String operator : QUERY_OPERATOR) {
        ...
        classPropertyWrapper.put(newProperty,
            new PropertyWrapper(property, type, getFilterOperator(operator)));
      }
    }
  }
  ...
  public void register(Class<?> clazz, String name, AccessibleObject accessibleObject,
    ...
    if (!type.equals(Object.class)) {
      ...
      for (String operator : QUERY_OPERATOR) {
        ...
        classPropertyWrapper.put(newProperty,
            new PropertyWrapper(name, type, getFilterOperator(operator)));
      }
    }
