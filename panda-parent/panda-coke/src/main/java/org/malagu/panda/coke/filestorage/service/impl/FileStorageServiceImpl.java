...
public class FileStorageServiceImpl implements FileStorageService {
	...
	@Override
	public CokeFileInfo put(MultipartFile file, String filename) throws IllegalStateException, IOException {
		return put(defaultFileStorageProviderType, file, filename);
	}

	@Override
	public CokeFileInfo put(String fileStorageType, InputStream inputStream, String filename) throws IOException {
	...
	public InputStream getInputStream(CokeFileInfo cokeFileInfo) throws FileNotFoundException {
		return getFileStorageProvider(cokeFileInfo.getFileStorageType()).getInputStream(cokeFileInfo.getRelativePath());
	}
